...
TrebSim.Structure = (function () {
  ...
  var WOODS = {
    ...
    // فولاذ إنشائي (S235): إجهاد خضوع انحنائي ≈ 250 MPa — به تُبنى
    // المنجنيقات الحديثة الضخمة. النموذج يفترض مقطعًا مصمتًا، فعند ضبط
    // كتلة الذراع يدويًا فهي تمثل ذراعًا أنبوبيًا/جمالونيًا مكافئًا.
    steel: { name: 'فولاذ إنشائي Steel', rho: 7850, mor: 250e6 }
  };
